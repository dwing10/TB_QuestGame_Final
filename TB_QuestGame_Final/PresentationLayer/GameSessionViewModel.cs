...
namespace TBQuestGame_S1.PresentationLayer
{
    public class GameSessionViewModel : ObservableObject
    {
        ...
        public void RemoveItemFromInventory()
        {
            ...
            {
                if (_currentGameItem.GameItem.Id == "INS")
                {
                    value = 150;
                }
                else if (_currentGameItem.GameItem.Id == "BOL")
                {
                    value = 100;
                }
                else if (_currentGameItem.GameItem.Id == "TRI")
                {
                    value = 0;
                }
        ...
        public void Move(string tagName)
        {
            ...
            {
                case "Alheimurrinn":
                    if (Player.NumOfSeigeWeapons >= 3 && Player.PraetorNumbers >= 1)
                    {
                    ...
                    else
                    {
                        ...
                        CurrentLocationInformation = "You will need to aquire more seige weapons before you can travel to this location. Additionally, you will " +
                            "not be able to defeat Alheimurrinn without a praetor in your chain of command, so make sure you have one.";
                    }

                    break;

                case "Qua Redi":
                    if (Player.NumOfSeigeWeapons >= 1 && Player.CenturionNumbers >= 5)
                    {
                        _currentLocation.IsAccessible = true;
                        foreach (Location location in AccessibleLocations)
                        {
                    ...
                    {
                        _currentLocation.IsAccessible = false;
                        CurrentLocationInformation = "You will need the port of Elkmire and seige weaponry to travel to this location. You will also need to train some Centurions if you hope to " +
                            "defeat Qua Redi.";
                    }
                    break;
        ...
        private void Battle()
        {
            if (_currentNPC is IBattle)
            {
                ...
                CurrentLocationInformation = TAB + $"{Player.LegionName} vs {_currentNPC.Name}"
                    + Environment.NewLine + "" + Environment.NewLine +
                    TAB + $"{Player.LegionName} Hit Point: {weightedPlayerHP}" + Environment.NewLine + "" + Environment.NewLine +
                    TAB + $"{_currentNPC.Name} Hit Point: {battleNpcHitPoints / playerTacticalAdvantage}";
        ...
        private void DetermineRewards(NPC currentNPC)
        {
            ...
            if (currentNPC.ID == "ENEMY4")
            {
                ...
                GameItemQuantity buff = _player.BuffsInventory.FirstOrDefault(i => i.GameItem.Id == "INS");
                if (buff != null)
                {
                    buff.Quantity = 1;
                    _player.Buffs.Add(buff);
                    _player.Inventory.Add(buff);
                }


                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = "" + TAB + $"You have defeated {currentNPC.Name} and have gained 200 gold!" + Environment.NewLine +
                                                 TAB + "Your prowess on the battlefield will inspire troops to fight harder for you in the future." + Environment.NewLine + "" + Environment.NewLine +
                                                 TAB + "You have gained an Inspiring Presence." + Environment.NewLine + "" + Environment.NewLine +
                                                 TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY5")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + $"You have defeated {currentNPC.Name} and have gained 350 gold!" + Environment.NewLine +
                                        TAB + "It also looks like your troops found a HELLFIRE GEM!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY6")
            {
                ...
                GameItemQuantity sword = _player.ArmorInventory.FirstOrDefault(i => i.GameItem.Id == "SWD");
                if (sword != null)
                {
                    sword.Quantity += 1;
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + $"You have defeated {currentNPC.Name} and have gained 550 gold!" + Environment.NewLine +
                                        TAB + "We are also pleased to imform you that the legendary SWORD OF KING MIDAS was" + Environment.NewLine + 
                                        TAB + "found in the king's private quarters."
                                        + Environment.NewLine + "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
            ...
            else if (currentNPC.ID == "ENEMY2")
            {
                ...
                GameItemQuantity buff = _player.BuffsInventory.FirstOrDefault(i => i.GameItem.Id == "TRI");
                if (buff != null)
                {
                    buff.Quantity = 1;
                    _player.Buffs.Add(buff);
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + $"You have defeated {currentNPC.Name} and have gained 700 gold!" + Environment.NewLine +
                                        TAB + "A Hellfire Gem was found in Dore's treasure vaults!" + Environment.NewLine +
                                        TAB + "Also, the high council has sent you a tribute chest to aid in your campaign." + Environment.NewLine + "" + Environment.NewLine +
                                        TAB + "You have gained a tribute." + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY3")
            {
                ...
                GameItemQuantity cuirass = _player.ArmorInventory.FirstOrDefault(i => i.GameItem.Id == "CUR");
                if (cuirass != null)
                {
                    cuirass.Quantity += 1;
                    _player.Inventory.Add(cuirass);
                ...
                GameItemQuantity buff = _player.BuffsInventory.FirstOrDefault(i => i.GameItem.Id == "BOL");
                if (buff != null)
                {
                    buff.Quantity = 1;
                    _player.Buffs.Add(buff);
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + $"You have defeated {currentNPC.Name} and have gained 1000 gold!" + Environment.NewLine +
                        TAB + "The cuirass of King Midas was also found in the treasure vaults." + Environment.NewLine +
                        TAB + "The high council has purchased some troops for you to aid in your campaign." + Environment.NewLine + "" + Environment.NewLine +
                        TAB + "You have gained Bolster the Ranks" + Environment.NewLine +
                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY1")
            {
                ...
                if (gameItemQuantity != null)
                {
                    gameItemQuantity.Quantity += 2000;
                    _player.Treasures.Clear();
                    _player.Treasures.Add(gameItemQuantity);
                }
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + $"You have defeated {currentNPC.Name} and have gained 2000 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
        ...
        private void DetermineLosses(NPC currentNPC)
        {
            ...
            if (currentNPC.ID == "ENEMY4")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 100 gold!" + Environment.NewLine +
                                       "" + Environment.NewLine +
                                       TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY5")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 300 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY6")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 550 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY2")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 700 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY3")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 1000 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
            ...
            else if (currentNPC.ID == "ENEMY1")
            {
                ...
                Task.Delay(5000).ContinueWith(_ =>
                {
                    CurrentLocationInformation = TAB + "You have been defeated and have lost 10000 gold!" + Environment.NewLine +
                                        "" + Environment.NewLine +
                                        TAB + $"Legionnaire lost in the battle: {troopLosses}";
                }
                );
        ...
        //checks if player's power is zero, if so they lose
        ...
        public void CheckIfNPCHasItem(NPC currentNPC)
        {
            if (currentNPC.ID == "NOBLE")
            {
                CurrentLocationInformation += "" + Environment.NewLine + "" + Environment.NewLine + "The nobleman slipped you " +
                    ...
                    "Empire. As a token of good faith, the parchment alos explains that a nearby ancient ruin may contain valuable treasure. " +
